...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('DPD-RI.png') }}">
...
<body class="bg-gray-50">
    ...
    <div class="bg-green-800 text-white text-sm ">
        <div class="max-w-7xl mx-auto px-4 py-2 flex justify-between items-center">
            ...
            <div class="flex gap-4 items-center">
                <a href="#" class="hover:text-green-300 font-semibold animate__animated animate__fadeIn">ID</a>
                <span>|</span>
                <a href="#" class="hover:text-green-300 animate__animated animate__fadeIn">EN</a>
                <span class="ml-2 text-xs bg-green-700 px-2 py-1 rounded animate__animated animate__fadeIn">unknown developer</span>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden lg:flex gap-8 text-gray-700 font-medium animate__animated animate__fadeInDown">
                    <a href="#" class="hover:text-green-600 transition border-b-2 border-green-600 pb-1">Beranda</a>
                    <a href="#" class="hover:text-green-600 transition">Berita</a>
                    <a href="#" class="hover:text-green-600 transition">Agenda</a>
                    <a href="#" class="hover:text-green-600 transition">Profil</a>
                    <a href="#" class="hover:text-green-600 transition">Publikasi</a>
    ...
    <!-- HERO SECTION -->
    <section class="relative bg-gradient-to-br from-green-800 via-green-700 to-green-600 overflow-hidden ">
        ...
        <!-- Decorative Elements -->
        <div class="absolute top-0 right-0 w-96 h-96 bg-green-600 rounded-full filter blur-3xl opacity-20"></div>
        <div class="absolute bottom-0 left-0 w-96 h-96 bg-green-900 rounded-full filter blur-3xl opacity-20"></div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 py-24 md:py-32">
            ...
            <p class="text-lg md:text-xl text-green-100 max-w-2xl mb-8 ml-4">
                Informasi terkini seputar kegiatan, kebijakan, dan layanan publik dari Dewan Perwakilan Daerah
            </p>
            <div class="flex gap-4 ml-4">
                <a href="#berita" class="bg-white text-green-800 px-6 py-3 rounded-lg font-semibold hover:bg-green-50 transition shadow-lg">
                    Baca Berita
                </a>
                <a href="#" class="border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-green-800 transition">
    ...
    <!-- BREAKING NEWS -->
    <section class="bg-gradient-to-r from-green-700 to-green-600 text-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 py-3">
            <div class="flex items-center gap-4">
                <span class="bg-white text-green-700 px-4 py-1.5 rounded font-bold text-sm whitespace-nowrap">
                    BREAKING
                </span>
                <div class="flex-1 overflow-hidden">
                    <p class="breaking-news whitespace-nowrap">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-8">
                ...
                <div class="bg-white shadow-xl rounded-2xl overflow-hidden hover-lift mb-12">
                    <div class="relative">
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="bg-green-600 text-white px-4 py-1.5 rounded-full text-sm font-semibold shadow-lg">
                                Utama
                            </span>
                        </div>
                    </div>
                    <div class="p-8">
                        ...
                        <h4 class="text-3xl font-bold text-gray-800 mb-4 hover:text-green-600 transition cursor-pointer leading-tight">
                            DPD Kota Gorontalo
                        </h4>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-white shadow-lg rounded-xl overflow-hidden hover-lift group">
                        ...
                        <div class="p-5">
                            ...
                            <h4 class="font-bold text-lg text-gray-800 mb-2 group-hover:text-green-600 transition cursor-pointer line-clamp-2">
                    ...
                    <div class="bg-white shadow-lg rounded-xl overflow-hidden hover-lift group">
                        ...
                        <div class="p-5">
                            ...
                            <a href="#" class="inline-flex items-center gap-1 text-green-600 text-sm font-semibold hover:gap-2 transition-all">
                                Selengkapnya 
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                </svg>
                ...
                <div class="text-center mt-10">
                    <button class="bg-green-600 text-white px-10 py-3 rounded-lg font-semibold hover:bg-green-700 transition shadow-lg hover:shadow-xl">
                        Muat Berita Lainnya
                    </button>
                </div>
            ...
            <aside class="lg:col-span-4 space-y-6">
                ...
                <div class="bg-white shadow-lg rounded-xl p-6">
                    ...
                    <div class="relative">
                        <input type="text" placeholder="Cari berita..." 
                               class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 pr-12 focus:outline-none focus:border-green-500 transition">
                        <button class="absolute right-2 top-1/2 -translate-y-1/2 bg-green-600 text-white p-2 rounded-lg hover:bg-green-700 transition">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                            </svg>
                        </button>
                ...
                <div class="bg-white shadow-lg rounded-xl p-6">
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="#" class="flex justify-between items-center p-3 rounded-lg hover:bg-green-50 transition group">
                                <span class="text-gray-700 group-hover:text-green-600 font-medium">Berita Daerah</span>
                                <span class="bg-green-100 text-green-700 text-xs px-3 py-1 rounded-full font-semibold">1</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex justify-between items-center p-3 rounded-lg hover:bg-green-50 transition group">
                                <span class="text-gray-700 group-hover:text-green-600 font-medium">Berita 3 baris kepailitan</span>
                                <span class="bg-green-100 text-green-700 text-xs px-3 py-1 rounded-full font-semibold">3</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex justify-between items-center p-3 rounded-lg hover:bg-green-50 transition group">
                                <span class="text-gray-700 group-hover:text-green-600 font-medium">Ngeriteak Beitian</span>
                                <span class="bg-green-100 text-green-700 text-xs px-3 py-1 rounded-full font-semibold">8</span>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <!-- AGENDA -->
                <div class="bg-gradient-to-br from-green-700 to-green-600 text-white shadow-lg rounded-xl p-6">
                    ...
                    <ul class="space-y-4">
                        <li class="border-l-4 border-white pl-4 py-2 hover:bg-green-600 rounded-r-lg transition cursor-pointer">
                ...
                <div class="bg-white shadow-lg rounded-xl p-6">
                    ...
                    <ul class="space-y-4">
                        <li class="flex gap-3 group cursor-pointer">
                            ...
                            <div class="flex-1">
                                <h5 class="text-sm font-semibold text-gray-800 group-hover:text-green-600 transition line-clamp-2 mb-1">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 mb-8">
                ...
                <div class="md:col-span-4">
                    ...
                    <div class="flex gap-3">
                        <a href="#" class="w-10 h-10 bg-green-600 rounded-lg flex items-center justify-center hover:bg-green-700 transition">
                ...
                <div class="md:col-span-2">
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="#" class="hover:text-green-400 transition flex items-center gap-2">
                            <span class="text-green-500">›</span> Profil DPD RI
                        </a></li>
                        <li><a href="#" class="hover:text-green-400 transition flex items-center gap-2">
                            <span class="text-green-500">›</span> Anggota DPD
                        </a></li>
                        <li><a href="#" class="hover:text-green-400 transition flex items-center gap-2">
                            <span class="text-green-500">›</span> Struktur Organisasi
                        </a></li>
                        <li><a href="#" class="hover:text-green-400 transition flex items-center gap-2">
                            <span class="text-green-500">›</span> Alat Kelengkapan
                        </a></li>
                    </ul>
                </div>
                ...
                <div class="md:col-span-3">
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="#" class="hover:text-green-400 transition flex items-center gap-2">
                            <span class="text-green-500">›</span> Aspirasi Masyarakat
                        </a></li>
                        <li><a href="#" class="hover:text-green-400 transition flex items-center gap-2">
                            <span class="text-green-500">›</span> Dokumen Publik
                        </a></li>
                        <li><a href="#" class="hover:text-green-400 transition flex items-center gap-2">
                            <span class="text-green-500">›</span> Transparansi Keuangan
                        </a></li>
                        <li><a href="#" class="hover:text-green-400 transition flex items-center gap-2">
                            <span class="text-green-500">›</span> PPID
                        </a></li>
                    </ul>
                </div>
            ...
            <div class="border-t border-gray-800 pt-6 text-center">
                <p class="text-sm text-gray-400">
                    © 2025 <span class="text-green-500 font-semibold">Dewan Perwakilan Daerah Provinsi Gorontalo</span>. Seluruh Hak Cipta Dilindungi.
                </p>
                <div class="flex justify-center gap-4 mt-3 text-xs text-gray-500">
                    ...
                    <span>•</span>
                    <a href="#" class="hover:text-green-400 transition">Sitemap</a>
                </div>
            </div>
        </div>
    </footer>
