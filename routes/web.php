...
Route::prefix('admin')->name('admin.')->group(function () {
   ...
   Route::get('/dashboard', [BeritaController::class, 'dashboardData']) // <--- Perubahan di sini!
        ->name('dashboard');
    // Hapus atau ganti route ini dengan yang di bawah:
    // Route::get('/dashboard/content', function () {
    //     return view('admin.dashboard-content');
    // })->name('dashboard.content'); // <--- Route yang SALAH, hapus ini
    ...
    Route::get('/dashboard', [BeritaController::class, 'indexDashboard']) // <-- Tambah method indexDashboard
        ->name('dashboard');
        
    // Kita biarkan dashboardData hanya untuk konten AJAX/SPA
